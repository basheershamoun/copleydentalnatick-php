...
Class Form 
{
    ...
    protected function validate_recaptcha($key){
    ...
    protected function validate_date($key, $required, $format){
        ...
        //validate when required or when the field has data
        if($required == true or $empty == false){
...
Class ContactForm extends Form{
    ...
    public function is_valid(){
        ...
        $this->validate_recaptcha($this->recaptcha);
...
Class RequestAppointmentForm extends Form{
    ...
    public function __construct($data, $config_captcha){
        ...
        $state_model = new StateModel("src/data/request_appointment.json");
        $hour_model = new HourModel("src/data/hours.json");
