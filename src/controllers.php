...
class ServicesController extends Controller
{
    ...
    public function service_post($request, $response, $args){
        ...
        if($is_valid === True){
            ...
            $email_send =$this->config["config"]["send_email_to"];
    ...
    /*
        Redirect to the services thank-you page
    */
    ...
    /*
        Contact form for services (shared template).
    */
...
class GalleryController extends Controller{
    ...
    public function gallery($request, $response){
        $context = array();
        $gallery = new GalleryModel("src/data/gallery.json");
